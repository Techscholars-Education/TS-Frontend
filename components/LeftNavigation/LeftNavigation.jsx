  ...
  return (
    <nav className="h-[100vh] bg-slate-50  w-64 py-8 px-4 flex flex-col justify-between">
      <div className='ml-8'>
        ...
        <h1 className="text-[#1A1A1A] font-[500] mb-4 ml-2 mt-1">TECHSCHOLARS</h1>
        </div>
        <ul className='mt-20'>
          <li className="flex items-center mb-10">
            <FiHome className="mr-2 text-[20px]" />
            <a href="#" className="text-[#8A8A8A] font-[700] hover:text-gray-400">Home</a>
          </li>
          <li className="flex items-center mb-10">
            <FiBookOpen className="mr-2 text-[20px]" />
            <a href="#" className="text-[#8A8A8A] font-[700]  hover:text-gray-400">My Course</a>
          </li>
          <li className="flex items-center mb-10">
            <FiClipboard className="mr-2 text-[20px]" />
            <a href="#" className="text-[#8A8A8A] font-[700]  hover:text-gray-400">Test Series</a>
          </li>
          <li className="flex items-center mb-10">
            <FiUsers className="mr-2 text-[20px]" />
            <a href="#" className="text-[#8A8A8A] font-[700]  hover:text-gray-400">Refer and Earn</a>
          </li>
          <li className="flex items-center mb-10">
            <FiRss className="mr-2 text-[20px]" />
            <a href="#" className="text-[#8A8A8A] font-[700]  hover:text-gray-400">Feed</a>
          </li>
          <li className="flex items-center mt-10">
            <FiMessageCircle className="mr-2 text-[20px]" />
            <a href="#" className="text-[#8A8A8A]  font-[700] hover:text-gray-400">Community</a>
          </li>
          <li className="flex items-center mt-10">
            <FiSettings className="mr-2 text-[20px]" />
            <a href="#" className="text-[#8A8A8A] font-[700]  hover:text-gray-400">Settings</a>
          </li>
        </ul>
      </div>
      <div>
