    ...
    <header className="py-2 bg-gray-100">
      <nav className=" w-5/6 mx-auto flex justify-evenly items-center">
        <div className="flex items-center">
          ...
          <h2 className={`${poppins.className} text-lg`}>TECHSCHOLARS</h2>
        </div>
        <ul className={`${poppins.className} flex gap-10  text-lg `}>
          <li>
        ...
        <div className="flex justify-center items-center gap-6">
          ...
          <button className=" border border-black/40 rounded-xl px-4 py-2 bg-yellow-400 text-lg text-neutral-800 hover:-translate-y-2  duration-300  auth-btn">
            Signup
          </button>
        </div>
      </nav>
