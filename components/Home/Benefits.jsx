...
const Benefits = () => {
  return (
    <div className=" w-11/12 xl:w-10/12 grid grid-cols-1 md:grid-cols-2  mx-auto gap-4 ">
      ...
      <div className=" bg-[#FCE2EB4D] rounded-xl flex px-6 py-6 md:py-8 font-Poppins hover:scale-100 hover:shadow-xl transition-all duration-200 ">
        <div className="my-auto">
      ...
      <div className=" bg-[#DCF4F566] rounded-xl flex px-6 py-6 md:py-8 font-Poppins hover:scale-100 hover:shadow-xl transition-all duration-200 ">
        <div className="my-auto">
