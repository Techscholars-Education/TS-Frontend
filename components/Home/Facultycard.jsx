...
const Facultycard = (props) => {
  return (
    <div className=" h-[44vh] md:h-[52vh] lg:h-[56vh] xl:h-full  font-Poppins my-10 mx-4 xl:mx-8  border-opacity-60 rounded-lg overflow-hidden p-2 bg-white shadow-md hover:shadow-xl hover:scale-105 duration-200 flex flex-col justify-between ">
