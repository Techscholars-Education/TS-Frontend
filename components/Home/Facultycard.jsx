...
const Facultycard = (props) => {
  return (
    <div className=" xl:w-[380px]  xl:mx-2.5 lg:mx-10 md:mx-4 h-[440px] md:h-[460px] lg:h-[460px] shadow-sm font-Inter my-10 relative border-opacity-60 rounded-3xl  bg-white hover:shadow-lg hover:scale-105 duration-200 flex flex-col  ">
      ...
      <div className="py-3  h-[150px] md:h-[180px] lg:h-[200px]  xl:h-[160px] relative px-2 font-Poppins ">
        <h1 className="title-font text-xl md:text-2xl font-semibold text-black rounded-md mb-0 p-4 ">
          {props.item.name}
        </h1>
        <p className="leading-relaxed mb-3 text-TechBlue font-medium  text-lg md:text-lg px-4">
          {props.item.qualification}
        </p>
        <h6 className=" text-lg md:text-lg  text-black/70 mb-3 font-medium px-4">
