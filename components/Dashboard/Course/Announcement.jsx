            ...
            <div className='flex flex-col bg-white rounded-xl p-3 md:mr-10 mt-4 md:ml-10'>
                <div className="grid md:grid-cols-3 grid-cols-1">
                    {announcement.map((ele) => (
                        <div className='flex flex-col m-4 border border-gray-100 rounded-lg w-[21vw] p-5 gap-3' key={ele.id}>
                            <div id='upper' className='pt-3 pb-3 pl-2 pr-2 bg-gray-100 rounded-lg flex justify-between'>
                                <div id='icons' className='flex items-center gap-2'>
                                    <Image src={logo} className='h-12 w-12 bg-white p-2 rounded-lg' alt='logo' />
                                    <div className='flex flex-col'>
                                        <h1 className='font-semibold text-[.9vw]'>TS Team</h1>
                                        <p className='font-normal text-[.6vw] text-gray-300'>12 hours ago</p>
                                    </div>
                                </div>
                            ...
                            <div id='mid' className=''>
                                <Image src={ele.img} className='h-40 w-full object-cover rounded-xl' alt={`${ele.subject}`} />
                            </div>
                            <div id='lower' className='flex flex-col gap-2'>
                                <h1 className='text-[.8vw] font-normal text-gray-400'>
                                    We are thrilled to announce the launch of your go-to platform for high-quality online education. 
                                    Whether you&#39;re looking to advance your career, learn a new skill, or explore a personal interest.
                                </h1>
                                <p className='font-normal text-[.8vw] underline'>www.techscholars.com/physics.n.26</p>
                            </div>
                        </div>
                    ))}
                </div>
