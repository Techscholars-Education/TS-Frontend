    ...
    <div className="flex flex-col items-center">
      <div className="flex border border-gray-600 rounded-full p-1 max-sm:mt-1">
        <button
          ...
          className={` py-1 px-2.5 text-[.7vw] max-sm:py-0 max-sm:px-1 max-md:py-1 max-md:px-2 max-lg:px-2 max-lg:py-1  max-xl:px-2 max-xl:py-1 rounded-full transition-colors duration-300 max-sm:text-[3vw] ${
