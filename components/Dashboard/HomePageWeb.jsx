                        ...
                        <div className='flex justify-between mt-3 h-[240px] w-[55vw]'>
                            ...
                            <div className=' p-6 bg-white rounded-3xl ml-3 w-[400px] '>
                                ...
                                <div className='flex justify-between h-[48.2px]'>
                                    <p>Physics</p>
                                    <CircularProgressWithLabel value={progress} className="text-gradient-to-r from-orange-400 via-red-500 to-pink-500" />
                                ...
                                <div className='flex justify-between mt-3'>
                                    <div className='flex'>
                                        ...
                                        <div className='flex flex-col ml-3'>
                                            ...
                                            <p className='font-[600] text-[10px] text-[#8A8A8A]'>Lorem ipsum dolor sit amet.</p>
                                            <button className='bg-white  border-slate-400 border px-2 rounded-full font-[700] py-1 text-[10px]'>First Chapter of Project .doc</button>
                                        </div>
                                    </div>
                                    <div>
                                        <p className='text-[#8A8A8A] font-[800] text-[10px]'>09:31 am</p>
                                    </div>
                                </div>
                            ...
                            <div className='flex flex-col rounded-3xl ml-3 bg-white p-3 w-[400px]  '>
                                ...
                                <div className='flex justify-between mt-2 bg-[#FFD700] p-2 rounded-3xl '>
                                    ...
                                    <div style={{ position: 'relative', bottom: '7px' }}>
                                        <Image src={require('../../public/Home/maddle.png')} />
                                    </div>
                                </div>
