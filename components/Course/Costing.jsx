...
const Costing = (props) => {
        ...
        <ul className="pt-6 px-6 space-y-4 font-Inter">
          ...
          <li className="flex justify-start space-x-2 items-center  ">
            ...
            <div className="flex justify-center  ">
              <button className="text-xl font-bold"  onClick={()=>setStarter(true)}>
              ...
            </button>
            </div>
          }
  ...
  <ul className="pt-6 px-6 space-y-4">
    ...
    <li className="flex justify-start space-x-2 items-center">
      <MdDone className="bg-white text-xl text-TechBlue font-bold rounded-full p-1" />
      <span className="text-white text-xs md:text-sm">Weekly test series</span>
    </li>
    <li className="flex justify-start space-x-2 items-center">
      <MdDone className="bg-white text-xl text-TechBlue rounded-full p-1" />
      <span className="text-white text-xs md:text-sm">All India Test series</span>
    </li>
    <li className="flex justify-start space-x-2 items-center">
      <MdDone className="bg-white text-xl text-TechBlue rounded-full p-1" />
      <span className="text-white text-xs md:text-sm"><span className="font-bold">LIVE</span> doubt clearing sessions</span>
    </li>
    {advanced ? (
      <>
        <li className="flex justify-start space-x-2 items-center">
          <MdDone className="bg-white text-xl text-TechBlue rounded-full p-1" />
          <span className="text-white text-xs md:text-sm">Access to smartest student community</span>
        </li>
        <li className="flex justify-start space-x-2 items-center">
          <MdDone className="bg-white text-xl text-TechBlue rounded-full p-1" />
          <span className="text-white text-xs md:text-sm"><span className="font-bold">One shot</span> Revision series</span>
        </li>
        <li className="flex justify-start space-x-2 items-center">
          <RxCross2 className="bg-red-400 text-xl text-white rounded-full p-1" />
          <del className="text-white font-medium text-xs md:text-sm">Scholars<span className="font-bold"> AI </span> (beta)</del>
        </li>
        <li className="flex justify-start space-x-2 items-center">
          <RxCross2 className="bg-red-400 text-xl text-white rounded-full p-1" />
          <del className="text-white font-medium text-xs md:text-sm">Personalised Performance Analysis</del>
        </li>
        <li className="flex justify-start space-x-2 items-center">
          <RxCross2 className="bg-red-400 text-xl text-white rounded-full p-1" />
          <del className="text-white font-medium text-xs md:text-sm">One - One <span> Mentorship </span> sessions</del>
        </li>
        <li className="flex justify-start space-x-2 items-center">
          <RxCross2 className="bg-red-400 text-xl text-white rounded-full p-1" />
          <del className="text-white font-medium text-xs md:text-sm">Access to<span> Digital </span> student library</del>
        </li>
        <li className="flex justify-start space-x-2 items-center">
          <RxCross2 className="bg-red-400 text-xl text-white rounded-full p-1" />
          <del className="text-white font-medium text-xs md:text-sm">Regular Workshops, Strategy and Councilling Sessions.(with Certifications).</del>
        </li>
      </>
    ) : (
      <div className="flex justify-center">
        <button className="text-xl font-bold" onClick={() => setAdvanced(true)}>...</button>
      </div>
    )}
  </ul>
  <div className="w-full flex justify-center items-center my-6">
    <Link href="/dashboard/courses" className="border border-gray-400 w-5/6 rounded-full bg-white text-TechBlue px-4 md:px-6 py-2 md:py-3 text-center hover:bg-black hover:text-white duration-200 font-Poppins font-semibold">Purchase Now</Link>
  </div>
  <span datacontent="MOST POPULAR" className="w-[100px] h-[100px] absolute font-bold flex justify-center items-center -top-2 -right-2 overflow-hidden before:w-[180px] before:h-8 before:bg-white before:absolute before:rotate-45 before:-translate-y-4 before:content-[attr(dataContent)] before:flex before:justify-center before:items-center before:text-xs before:pl-6 before:text-TechBlue before:shadow-md"></span>
</div>
        ...
        <ul className="pt-6 px-6 space-y-4 font-Inter">
          ...
          <li className="flex justify-start space-x-2 items-center  ">
            ...
            <span className="text-gray-600 text-xs md:text-sm font-medium font-Poppins ">
              ...
              <button className="text-xl font-bold"  onClick={()=>setUltimate(true)}>
              ...
            </button>
            </div>
