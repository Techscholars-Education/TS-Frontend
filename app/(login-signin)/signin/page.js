            ...
            <div className='flex w-full h-screen'>
                ...
                <div className="flex flex-col justify-center items-center h-screen w-full ">
                    <nav className='flex justify-end w-[60vw] pt-12 '>
                        ...
                        <a href="/login" className='font-[600] ml-2'>Log in</a>
                    </nav>
                    <div className="flex flex-col justify-center items-center h-screen w-full">
                        ...
                        <div className=" w-[568] h-[418] p-8">
                            <form className=" px-8 pt-6 mb-4 h-[463px]  w-[418px] ">
                                ...
                                <div className="flex flex-col  items-center justify-between">
                                   <Box sx={{ width: '100%' ,}}>
                                        <LinearProgress Height="20" variant="determinate" value={progress} style={{ height: '4px', borderRadius: '10px',color:'#041C3B',backgroundColor:'#DCDCDC' }} />
                                      <div className='flex justify-between mt-2'>
                                      <span className='text-[#898989] text-[12px] font-[400]'>Your password is great. Nice work!</span>
                                        <span className='text-[#898989] text-[12px] font-[400]'>Strong</span>
                                      </div>
                                    </Box>
