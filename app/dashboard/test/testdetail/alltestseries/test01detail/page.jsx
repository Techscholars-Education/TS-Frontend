      ...
      <section className="flex  overflow-x-hidden">
        ...
        <div className='flex flex-col'>
          ...
          <div className=" font-Poppins min-h-screen  w-[80vw] bg-[#f7faff] ">
            ...
            <div className=" md:my-4 flex flex-col md:mx-8 ">
              <div className='flex bg-slate-200 md:p-2 md:px-3 rounded-full w-24'>
              ...
              <div className='flex flex-col md:mr-2 mt-4 md:mt-12'>
              ...
              <div className='flex flex-col bg-white rounded-xl md:p-8 mt-12'>
