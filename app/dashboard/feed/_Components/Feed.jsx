...
const Feed = () => {
    ...
    return (
        <div className="bg-white font-Poppins h-screen w-full ">
            ...
            <div className="my-6 flex flex-col mr-2 bg-blue-50 h-[82vh] max-w-full pl-5 pr-5 pt-5  overflow-y-auto">
           ...
           <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mt-4 w-[80vw]  ">
