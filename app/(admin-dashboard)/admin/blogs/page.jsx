        ...
        <div>
            ...
            <div>
                ...
                <div className='ml-10 mt-4 flex gap-7'>
                    <button onClick={()=>setBlogs(!blogs)} className='flex flex-col items-center justify-center gap-5 bg-white h-[20vw] w-[20vw] p-4 rounded-md cursor-pointer'>
                            ...
                            <div className='bg-white h-[37.8vw] w-[76vw] ml-16 mt-3 rounded-md relative'>
                                ...
                                <div className='pl-2 pr-2 '>
                                    ...
                                    <div className="w-full mt-2">
                                        <textarea name="" id="" className='h-[17vw] w-full border-2 border-gray-400 focus:border-black transition-all ease-in-out duration-200 rounded-lg p-2' value={input} onChange={(e)=> setInput(e.target.value)}></textarea>
                                    </div>
                                    
                                </div>
                                <button onClick={()=>setBlogs(!blogs)} className='bg-yellow-500 p-3 rounded-xl font-semibold absolute bottom-2 right-5 hover:bg-yellow-700 hover:text-white transition-all ease-in-out duration-200 '>Publish</button>
                            </div>
