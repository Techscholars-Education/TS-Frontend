      ...
      {domLoaded ? (
        <div className="h-screen w-full overflow-hidden">
          ...
          <div className="flex">
            ...
            <div
              id="home"
              className="bg-gray-100 overflow-y-auto h-screen w-[83.5vw] relative right-[-15vw]  rounded-md"
            >
              <div className="">
              ...
              <div className="flex ml-[2vw] gap-4 mt-2">
                {admin.map((item, id) => (
                  <div
                    className="bg-white h-[8vw] w-[20vw] ml-2 p-2 pl-3 rounded-md flex justify-between"
                    key={id}
                  >
              ...
              <div className="h-[60vh] w-[63vw] bg-white rounded-md mt-4 ml-10 flex flex-col gap-5">
                <div className="flex gap-5 ml-8 ">
                  <button className="pl-3 pr-3 pt-2 pb-2 bg-purple-200 rounded-xl mt-3 hover:bg-[#012656] hover:text-white transition-all ease-in-out duration-150 cursor-pointer">
                    Live User Count
                  </button>
                  <button className="pl-3 pr-3 pt-2 pb-2 bg-purple-200 rounded-xl mt-3 hover:bg-[#012656] hover:text-white transition-all ease-in-out duration-150 cursor-pointer">
                    Average Time Spent
