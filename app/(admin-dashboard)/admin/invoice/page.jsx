           ...
           <div className='w-[76vw] h-[13vw]  pt-[2vw] pl-[3vw] pr-[3vw] flex gap-[18vw]'>
                <div className='flex flex-col gap-2'>
                    <div className='flex gap-2'>
                        ...
                        <h2 className='text-[.9vw] font-semibold'>Codementor Hub Education Pvt Ltd</h2>
                    </div>
                    <div className='flex gap-2'>
                        ...
                        <h2 className='text-[.9vw] '>Email ID : dsjhdjhsd@gmail.com</h2>
                        <h2 className='text-[.9vw] '>A-4, XYZ Street, XYZ City, XYZ State, PIN : XYZ ,INDIA </h2>
                ...
                <div className='flex gap-2'>
                    ...
                    <div className='flex flex-col gap-5 mt-[2vw] '>
                        ...
                        <h1>Amount Received in words : Rupees Two Thousand Nine Hundred Forty Eight Rupees and Eighty Two Paisa Only.</h1>
                        </div>

                        <h1>Notes:  This is a computer generated pay receipt ,does not require signature</h1>
                    </div>    
                      </div>
                      <div className='w-[76vw] h-[9vw] pl-[3vw] pr-[3vw] relative '>
                                <div className='absolute right-5 flex gap-3'>
                                <AiFillPrinter className='p-2 h-10 w-10 border-2 border-gray-300 rounded-lg cursor-pointer' />
                                <button className='pl-3 pr-3 pt-2 pb-2 text-white bg-[#11047A] rounded-md flex items-center'>Upload <FaRegPaperPlane /></button>
                                </div>
