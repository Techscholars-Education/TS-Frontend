                ...
                <div className='flex gap-2'>
                    ...
                    <div className='flex flex-col gap-5 mt-[2vw] '>
                      ...
                      <div className='w-[76vw] h-[9vw] pl-[3vw] pr-[3vw] relative '>
                                ...
                                <button className='pl-3 pr-3 pt-2 pb-2 text-white bg-[#002956] rounded-md flex items-center hover:bg-black transition-all ease-in-out duration-200 gap-1'>Upload <FaRegPaperPlane /></button>
                                </div>
