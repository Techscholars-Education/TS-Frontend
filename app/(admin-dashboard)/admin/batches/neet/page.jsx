        ...
        <Image src="https://flowbite.com/docs/images/carousel/carousel-3.svg" alt="..." width={10} height={10} priority={true}/>
                  ...
                  <div className="lower mt-2 flex flex-col gap-2">
                        <div className="flex  justify-between">
                            ...
                            <div className='rounded-full p-2 cursor-pointer h-10 w-10 flex items-center justify-center bg-gray-100 transition-all ease-linear duration-200'  onClick={() => setHeart(!heart)}>
